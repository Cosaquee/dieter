<script>
  ...
  const config = {
    domain: "ex-budget.eu.auth0.com",
    client_id: "zBBF3P4DPTF09f3752ni18Q3zG7Zs5FL",
...
<!-- TODO: Make sure that highlighting for selected segment works -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden sm:-my-px sm:ml-6 sm:flex">
            <a
              ...
              focus:outline-none focus:border-indigo-700 transition duration-150
              ease-in-out">
              Breakfast
            </a>
            <a
        ...
        <div class="hidden sm:ml-6 sm:flex sm:items-center">
          {#if $isAuthenticated}
            <button class="font-medium leading-5 text-grey-600" on:click={() => logout()}>Logout</button>
          {:else}
            <button class="font-medium leading-5 text-grey-700" on:click={() => login()}>Login</button>
          {/if}
          <!-- <button
